...
export default class App extends Component {
  pagesize =5;
  apiKey='761fd8c860b14b9a84f7eaae40ee6827'
  state={
    progress:0
  }
  ...
  render() {
    return (
      ...
      />
        ...
        <Route exact path="/technology" element={<News setProgress={this.setProgress} apiKey={this.apiKey}  key="technology  jnj" pageSize={5} country= "in" category="technology" />}/>
        </Routes>
        </Router>
